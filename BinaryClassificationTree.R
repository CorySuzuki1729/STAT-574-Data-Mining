...
library(CHAID)
tree.CHAID<- chaid(as.factor(pneumonia) ~ as.factor(age.cat) + as.factor(male) 
+ as.factor(tobacco.yes) + as.factor(PM2_5.cat), data=train, control=chaid_control(maxheight=3))
